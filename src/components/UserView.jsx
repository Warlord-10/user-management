...
function UserView() {
    ...
    return (
        <div className='h-full flex flex-col gap-2'>
            <div className='grow flex flex-col bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden'>
                <div className='p-4 border-b border-gray-200'>
                    <div className='flex items-center justify-between'>
                        <h1 className='text-xl font-semibold text-gray-800'>Team Members</h1>
                        <span className='px-3 py-1 text-sm font-medium text-blue-600 bg-blue-50 rounded-full'>
                            Your Role: {permission.charAt(0).toUpperCase() + permission.slice(1)}
                        </span>
                    </div>
                </div>
